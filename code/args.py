...
def load_args():
    parser = argparse.ArgumentParser('CBR-TPP')
    ...
    if args.local:
        args.pro_path="D:\lbq\lang\pythoncode\pycharm project\TPPBASE\CBR-TPP"
        args.data_path="D:\lbq\lang\pythoncode\pycharm project\TPPBASE\TPP\data\TNPP"
    else:#remote server to run this code
        args.pro_path="/data/liubingqing/debug/TPPBASE/CBR-TPP"
        args.data_path = "/data/liubingqing/debug/TPPBASE/TPP/data/TNPP"
    return args
